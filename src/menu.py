...
def run_controller_menu(G, cb=lambda *args: None, args=None, noquit=False):
    ...
    if len(players) == 1:
        G["FRAMES"].add_frame("MAIN", (G["W"], G["H"]))
        G["FRAMEMAP"] = {
            "MAIN": (0, 0),
        }        
    elif len(players) == 2:
        G["FRAMES"].add_frame("MAIN", (G["W"]//2, G["H"]))
        G["FRAMES"].add_frame("MAIN2", (G["W"]//2, G["H"]))
        G["FRAMEMAP"] = {
            "MAIN": (0, 0),
            "MAIN2": (G["W"]//2, 0)
        }
    elif len(players) == 3:
        G["FRAMES"].add_frame("MAIN", (G["W"], G["H"]//2))
        G["FRAMES"].add_frame("MAIN2", (G["W"]//2, G["H"]//2))
        G["FRAMES"].add_frame("MAIN3", (G["W"]//2, G["H"]//2))
        G["FRAMEMAP"] = {
            "MAIN": (0, 0),
            "MAIN2": (0, G["H"] // 2),
            "MAIN3": (G["W"] // 2, G["H"] // 2)
        ...
        G["FRAMES"].add_frame("MAIN", (G["W"]//2, G["H"]//2))
        G["FRAMES"].add_frame("MAIN2", (G["W"]//2, G["H"]//2))
        G["FRAMES"].add_frame("MAIN3", (G["W"]//2, G["H"]//2))
        G["FRAMES"].add_frame("MAIN4", (G["W"]//2, G["H"]//2))
        G["FRAMEMAP"] = {
            "MAIN": (0, 0),
            "MAIN2": (G["W"] // 2, 0),
            "MAIN3": (0, G["H"] // 2),
